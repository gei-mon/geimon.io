export const totems = [
    {
        ...
        "Fake Doctor": "All Gain Life effects aimed towards a Player now Damage the Player that amount instead, and all Damage and Offer effects now Grant that amount of Life instead.", //
        ...
        "Shared Interest": "Neither Player can Damage their Opponent until the start of Turn 7.", //
