...
export const cards = [
    ...
    abilities: [
      {
        ...
        effect1type: "Standard",
        effect1condition: "",
        effect1cost: "Target1UndeadEitherTomb,Offer3",
    ...
    abilities: [
      {
        ...
        effect1cost: "DestroyYourBattlingChamp",
    ...
    abilities: [
      {
        ...
        effect1name: "",
        effect1type: "Reflex",
        effect1condition: "OppAttacks",
        effect1cost: "Mill4,TargetAttacker",
    ...
    abilities: [
      {
        ...
        effect1type: "Standard",
        effect1condition: "",
        effect1cost: "Target1ChampInOppTomb,Offer6",
  ...
  },
  {
    ...
    abilities: [
      {
        text: "Both Players draw 1 and reveal them; If the revealed card is a Champion, that Player can immediately Rally it (ignoring its cost).",
        keywords: ["blank"],
        effect1name: "",
        effect1type: "Standard",
        effect1condition: "",
        effect1cost: "BothDraw1",
    ...
    abilities: [
      {
        ...
        effect1type: "Standard",
        effect1condition: "",
        effect1cost: "Target1ChampInEitherTomb,Target3ChampsInTomb",
    ...
    abilities: [
      {
        ...
        effect1type: "Rush",
        effect1condition: "",
        effect1cost: "Target1ConstructOrHelperYouControl,TakeTargetDamage",
    ...
    abilities: [
      {
        ...
        keywords: ["blank"],
        effect1name: "",
        effect1type: ["Reflex","EndChain"],
        effect1condition: "OppControlsMore,OpponentActivates",
    ...
    abilities: [
      {
        ...
        effect1type: "Standard",
        effect1condition: "",
        effect1cost: "Excavate3,MillRevealedChampions",
    ...
    abilities: [
      {
        ...
        effect1type: "",
        effect1condition: "",
        effect1cost: "ObliterateAllCardsYouControl",
        effect1text: "ObliterateAllOppCards,BothDraw6",
        effect1linger: "",
        effect2name: "",
        effect2type: "",
        effect2condition: "",
    ...
    abilities: [
      {
        ...
        effect1name: "",
        effect1type: "",
        effect1condition: "OpponentBlocks",
        effect1cost: "Discard1",
