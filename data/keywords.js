export const keywords = {
  Bloodrage: "Increase this Champion&apos;s Damage equal to the Life it has lost from its initial value.",
  Bulletproof: "This Champion cannot be Damaged by battle. You take no Damage from battles involving this Champion.",
  Conscript: "If this Champion is Destroyed by battle (Mandatory): Resurrect it under the control of whichever Player Destroyed it. It is unable to declare an attack for the remainder of the turn.",
  ...
  Deathward: "If this Champion is Destroyed by battle: You take no Damage from that battle.",
  Defender: "This Champion must block when able. \n\n If you control 2 or more cards with this passive: You can block with either.",
  Duelist: "This Champion cannot deal Battle Damage to a Player.",
  Gravekeeper: "Cards that would be Retrieved or Resurrected are not.",
  Greedy: "If this Champion deals Battle Damage to a Player: Draw 1.",
  ...
  Lifetouch: "If this Champion battles another: Instead of Damaging that card, increase its Life by this card&apos;s Damage.",
  ...
  Warded: "This Champion cannot be Targeted by your Opponent&apos;s card effects.",
